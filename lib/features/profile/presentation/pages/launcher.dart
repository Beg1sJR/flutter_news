...
import 'package:news/features/profile/presentation/pages/profile.dart';

class ProfileLauncherPage extends StatelessWidget {
  const ProfileLauncherPage({super.key});
